createGrid();
$("#Start").append("<img src='../templates/assets/cartoon-car-transparent-background-18.png'  width='50' height='50'/>");
...
function createGrid(e) {
    var grid = clickableGrid(gridLen,gridLen, function (el, row, col, i) {
